...
<p align="center"> 
 ...
 <a href="https://www.python.org" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/python/python-original.svg" alt="python" width="40" height="40"/> </a>
   ...
   <a href="https://www.w3schools.com/css/" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/css3/css3-original-wordmark.svg" alt="css3" width="40" height="40"/> </a>
      ...
      <a href="https://expressjs.com/" target="_blank" rel="noreferrer"> <img src="https://cdn.worldvectorlogo.com/logos/nextjs-2.svg" alt="nextjs" width="40" height="40"/> </a>
...
| 2.  | [My Portfolio](https://github.com/VishalBhat07/my-portfolio)                        | A sleek platform to display your coding skills and projects.                                                                                                                                                                                         | [Live Website](https://vishal-bhat-portfolio.vercel.app/) |
...
| #   | Project                                                                             | Description                                                                                                                                                                                                                                          | Progress        |
| --- | ----------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| 1.  | [Zero Hunger](https://github.com/VishalBhat07/zero-hunger)                          | An innovative website where farmers can seamlessly trade crops and discover sellers. Powered by React JS and various APIs, Zero Hunger ensures a smooth and interactive buying and selling experience.                                                                                                                                                                                                                                                                              | [In Progress]   |
...
| 1.  | [Crop Connect](https://github.com/VishalBhat07/crop-connect)                     | A web platform integrating IoT for real-time farming management, offering tools for learning, buying, and automated agricultural control.                                                                                                                                                                                                                                                                              | [In Progress](https://github.com/VishalBhat07/crop-connect) |

### Competitive Programming Solutions 🖥️

| #   | Project                                                                   | Progress        |
| --- | ------------------------------------------------------------------------- | --------------- |
| 1.  | [My CodeForces Solutions](https://github.com/Hardvan/My-CodeChef-Solutions) | [In Progress]   |
| 2.  | [My LeetCode Solutions](https://github.com/Hardvan/My-Leetcode-Solutions) | [In Progress]   |

### C++ Based 💻

| #   | Project                                                                             | Description                                                                                                                                                                                                                                          | Progress        |
| --- | ----------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| 1.  | [QuizCraze](https://github.com/VishalBhat07/quiz-game)                              | Enter the QuizCraze, a C++ game designed for trivia enthusiasts. Compete in a variety of quiz challenges and test your knowledge across multiple subjects. Race against the clock to achieve the highest score.                                                                                                                                                                                                                                                                              | [Completed](https://github.com/VishalBhat07/quiz-game)   |
