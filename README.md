...
| --- | ----------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| 1.  | [WeatherWise](https://github.com/VishalBhat07/weather-wise)                          | A responsive app offering accurate weather forecasts through simple and stylish design.                                                                                                                                                                | [Live Website](https://weather-wise-ivory.vercel.app) |
| 2.  | [My Portfolio](https://github.com/VishalBhat07/my-portfolio)                        | A sleek platform that displays my coding skills and projects.                                                                                                                                                                                         | [Live Website](https://vishal-bhat-portfolio.vercel.app/) |
| 3.  | [TaskFlow](https://github.com/VishalBhat07/task-flow)                          | A modern to-do list app built for seamless task management. Easily add, edit, and remove tasks to stay productive throughout your day.                                                                                                         | [Live Website](https://task-flow-guide.vercel.app)   |
| 4.  | [CoinSync](https://github.com/VishalBhat07/coin-sync)                          | Stay synced with the latest market prices for all your favorite cryptos. Powered by Binance API, it offers real-time data in a user-friendly interface.                                                             | [Live Website](https://coin-sync-alpha.vercel.app) |
| 5.  | [TuneBox](https://github.com/VishalBhat07/tune-box)                            | A modern and responsive music streaming platform inspired by Spotify’s design. Experience playlists and tracks in an intuitive, music-driven interface. | [In Progress](https://github.com/VishalBhat07/tune-box)  |
| 6.  | [PassKeeper](https://github.com/VishalBhat07/pass-keeper)                      | An elegant and functional tool for managing your passwords securely. Store, organize, and retrieve your login details with a user-friendly UI.                                                                                                                                   | [In Progress](https://github.com/VishalBhat07/pass-keeper) |
| 7.  | [QuickCalc](https://github.com/VishalBhat07/quick-calc)                  | An easy-to-use calculator with a focus on simplicity and functionality. Ideal for basic calculations with a clear, responsive layout.                                                                                                                                   | [Live Website](https://quick-calc-two.vercel.app) |
...
| 4.  | [Agri Connect](https://github.com/VishalBhat07/agri-connect)                     | AgriConnect, my **`3rd semester major project`**, is a platform where farmers can buy and sell crops, learn best farming practices, and connect with local sellers to foster agricultural growth and community support.                                                                                                                                                                                                                                                                            | [In Progress](https://github.com/VishalBhat07/agri-connect) |
| 5.  | [RoadMapForge](https://github.com/VishalBhat07/roadmap-forge)                     | RoadMapForge is an interactive learning roadmap platform designed to help users navigate different learning paths. It provides curated roadmaps, progress tracking, and community contributions.                                                                                                                                                                                                                                                                              | [Completed](https://roadmap-forge-frontend.vercel.app) |
| 6.  | [Anonymous Feedback](https://github.com/VishalBhat07/anonymous-feedback)            | This is a REST API built on node JS for an anonymous teacher feedback system that allows students to submit feedback anonymously while ensuring participation is tracked without revealing identities. Teachers can view aggregated feedback.                                                                                                                                                                                                                                                                             | [Completed](https://github.com/VishalBhat07/anonymous-feedback) |
| 7.  | [ACM techTank Hackathon](https://github.com/VishalBhat07/techtank-hackathon-website)            | A full-stack web application developed for the **`Tech Tank Hackathon & Workshop`** as part of my role as a **`web developer at ACM RVCE`**. The platform was designed to display detailed hackathon information and seamlessly handle participant registrations.                                                                                                                                                                                                                                                                          | [Completed](https://techtank-hackathon-frontend-test.vercel.app) |
| 8.  | [Github-MCP](https://github.com/VishalBhat07/GitHub-MCP)            | A lightweight MCP (Model Context Protocol) server built on NodeJS that enables Claude 3.7 Sonnet to interact with GitHub via Octokit. Supports repository management, user actions, and GitHub metadata operations through tool calls.                                                                                                                                                                                                                                                                          | [Completed](https://github.com/VishalBhat07/GitHub-MCP) |
| 9.  | [ACM Official Website](https://github.com/VishalBhat07/GitHub-MCP)            | Official website of the **`ACM Club at RVCE`**, designed to showcase the chapter’s vision, technical events, workshops, team members, and achievements. Built with a clean, responsive UI to enhance community engagement and provide a central hub for all ACM activities.                                                                                                                                                                                                                                                                    | [In Progress](https://github.com/VishalBhat07/GitHub-MCP) |
| 10.  | [Skill Labs on MERN](https://github.com/VishalBhat07/SkillLabs-MERN)            | This repo contains all the steps, code snippets and resources for the MERN stack skill lab held for juniors at RVCE.                                                                                                                                                                                                                                                                   | [Completed](https://github.com/VishalBhat07/SkillLabs-MERN) |
...
| #   | Project                                                                             | Description                                                                                                                                                                                                                                          | Progress        |
| --- | ----------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| 1.  | [NeuralShield](https://github.com/VishalBhat07/neural-shield)                     | NeuralShield is an intelligent tool that analyses uploaded files to detect potential malware threats using static features and machine learning algorithms.                                                                                                                                                                                                                                                                              | [In Progress](https://github.com/VishalBhat07/neural-shield) |
